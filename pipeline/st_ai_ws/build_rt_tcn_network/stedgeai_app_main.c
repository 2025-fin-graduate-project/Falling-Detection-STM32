...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(tcn_network) // Defines NN_Instance_tcn_network and NN_Interface_tcn_network with network.c info

AI_ALIGNED(32)
static ai_u8 activations_1[0];
AI_ALIGNED(32)
static ai_u8 activations_2[122880];
AI_ALIGNED(32)
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_tcn_network);
  }
}
