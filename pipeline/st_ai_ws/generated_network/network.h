...
#define STAI_NETWORK_ORIGIN_MODEL_NAME         "fall_detection_tcn"
#define STAI_NETWORK_ORIGIN_MODEL_SIGNATURE    "0x32857d1871785c054637edf01bb4098e"

/*  Generated model name and signature  */
#define STAI_NETWORK_MODEL_NAME                "network"
#define STAI_NETWORK_MODEL_SIGNATURE           (0x4fc54e0b9f010479)
...
#define STAI_NETWORK_IN_1_SHAPE       {1,55,60}
#define STAI_NETWORK_IN_1_BATCH       (1)
#define STAI_NETWORK_IN_1_CHANNEL     (55)
#define STAI_NETWORK_IN_1_HEIGHT      (60)
#define STAI_NETWORK_IN_1_RANK        (2)
#define STAI_NETWORK_IN_1_SIZE        (3300)
#define STAI_NETWORK_IN_1_SIZE_BYTES  (13200)

/*****************************************************************************/
/*  Macros to declare output buffers characteristics  */
#define STAI_NETWORK_OUT_NUM             (1)
#define STAI_NETWORK_OUT_SIZE_BYTES      (12)
...
#define STAI_NETWORK_OUT_1_FLAGS       (STAI_FLAG_OUTPUTS|STAI_FLAG_PREALLOCATED|STAI_FLAG_CHANNEL_FIRST|STAI_FLAG_HAS_BATCH)
#define STAI_NETWORK_OUT_1_FORMAT      (STAI_FORMAT_FLOAT32)
#define STAI_NETWORK_OUT_1_SHAPE       {1,2,1}
#define STAI_NETWORK_OUT_1_BATCH       (1)
#define STAI_NETWORK_OUT_1_CHANNEL     (2)
#define STAI_NETWORK_OUT_1_HEIGHT      (1)
#define STAI_NETWORK_OUT_1_RANK        (2)
#define STAI_NETWORK_OUT_1_SIZE        ((1 * 2))
#define STAI_NETWORK_OUT_1_SIZE_BYTES  (8)

/*****************************************************************************/
/*  Macros to declare activations buffers characteristics  */
#define STAI_NETWORK_ACTIVATIONS_SIZE              (82944)
#define STAI_NETWORK_ACTIVATIONS_SIZE_BYTES        (82944)
...
#define STAI_NETWORK_ACTIVATION_1_SIZE       (82944)
#define STAI_NETWORK_ACTIVATION_1_SIZE_BYTES (82944)
...
#define STAI_NETWORK_WEIGHTS_SIZE                  (538444)
#define STAI_NETWORK_WEIGHTS_SIZE_BYTES            (538444)
...
#define STAI_NETWORK_WEIGHT_1_SIZE        (538444)
#define STAI_NETWORK_WEIGHT_1_SIZE_BYTES  (538444)
