...
/*****************************************************************************/
#define _STAI_GRU_NETWORK_MODEL_SIGNATURE     "0xf9bb7efca9985ce1afcddde1d7d592a6"
#define _STAI_GRU_NETWORK_DATETIME            "2026-05-18T18:01:02+0900"
...
static const stai_network_info g_gru_network_info = {
  ...
  .activations = (stai_tensor[STAI_GRU_NETWORK_ACTIVATIONS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 33792),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
  .weights = (stai_tensor[STAI_GRU_NETWORK_WEIGHTS_NUM]) {
    STAI_INIT_TENSOR(
      ...
      STAI_DECLARE_ARRAY(int32_t, 1, 581128),
      STAI_EMPTY_ARRAY(),
      STAI_EMPTY_ARRAY()),
    },
...
void forward_lite_gru_gru(_stai_gru_network_context* net_ctx)
{
  ...
  gru_kernel_array.data = AI_PTR(net_ctx->_weights[0] + 116992);
  gru_kernel_array.data_start = AI_PTR(net_ctx->_weights[0] + 116992);
  gru_recurrent_array.data = AI_PTR(net_ctx->_weights[0] + 215296);
  gru_recurrent_array.data_start = AI_PTR(net_ctx->_weights[0] + 215296);
  gru_bias_array.data = AI_PTR(net_ctx->_weights[0] + 411904);
  gru_bias_array.data_start = AI_PTR(net_ctx->_weights[0] + 411904);
  ...
  gru_output0_array.data_start = AI_PTR(net_ctx->_activations[0] + 13312);
...
static const ai_u32 conv1d_conv2d_t_in_0_shape_ch_const_u32 = 27;
...
static const ai_size gru_1_t_in_0_shape_ch_const_size = 128;


static const ai_i32 dense_t_in_0_shape_ch_prod_const_s32 = 64;
  ...
  const stai_run_mode mode)
{
  ...
  /* LITE_KERNEL_SECTION BEGIN conv1d_conv2d */
  {
    ...
    ai_float* conv1d_conv2d_t_out_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 4860);
    const ai_u8* conv1d_conv2d_t_weight_0_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 0);
    const ai_u8* conv1d_conv2d_t_weight_1_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 34560);
    ai_float* conv1d_conv2d_t_scratch_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 4320);
  ...
  {
      ai_handle conv1d_t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 4860);
    const ai_handle conv1d_t_in_0_ptr_const_handle = (ai_handle)(net_ctx->_activations[0] + 4860);
  ...
  {
      const ai_float* conv1d_1_conv2d_t_in_0_ptr_const_f32 = (ai_float*)(net_ctx->_activations[0] + 4860);
    ai_float* conv1d_1_conv2d_t_out_0_ptr_f32 = (ai_float*)(net_ctx->_activations[0] + 15100);
    const ai_u8* conv1d_1_conv2d_t_weight_0_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 34816);
    const ai_u8* conv1d_1_conv2d_t_weight_1_ptr_const_u8 = (ai_u8*)(net_ctx->_weights[0] + 116736);
  ...
  /* LITE_KERNEL_SECTION BEGIN conv1d_1 */
  {
    ...
    const ai_handle conv1d_1_t_in_0_ptr_const_handle = (ai_handle)(net_ctx->_activations[0] + 15100);
  ...
  /* LITE_KERNEL_SECTION BEGIN gru_1 */
  {
    ...
    const ai_float* gru_1_t_weight_0_ptr_const_f32 = (ai_float*)(net_ctx->_weights[0] + 414976);
    const ai_float* gru_1_t_weight_1_ptr_const_f32 = (ai_float*)(net_ctx->_weights[0] + 513280);
    const ai_float* gru_1_t_weight_2_ptr_const_f32 = (ai_float*)(net_ctx->_weights[0] + 562432);
  ...
  /* LITE_KERNEL_SECTION BEGIN dense_dense */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 563968),
      .bias = (float*)(net_ctx->_weights[0] + 580352),
      .n_channel_in = 64,
      .n_channel_out = 64,
      .n_elements = 1,
    };
  
  _STAI_GRU_NETWORK_EVENT_NODE_START_CB(5, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 1536)});
  ...
  {
      ai_handle dense_t_out_0_ptr_handle = (ai_handle)(net_ctx->_activations[0] + 256);
  ...
  /* LITE_KERNEL_SECTION BEGIN dense_1_dense */
  {
      ...
      .weights = (float*)(net_ctx->_weights[0] + 580608),
      .bias = (float*)(net_ctx->_weights[0] + 581120),
      .n_channel_in = 64,
      .n_channel_out = 2,
      .n_elements = 1,
    };
  
  _STAI_GRU_NETWORK_EVENT_NODE_START_CB(7, 1, {(stai_ptr) (float*)(net_ctx->_activations[0] + 256)});
