...
#define LL_ATON_NETWORK_ORIGIN_MODEL_NAME   "st_movenet_lightning_a100_heatmaps_256_int8"
...
// Output buffer 1 -- Transpose_314_out_0
#define LL_ATON_NETWORK_OUT_1_ALIGNMENT   (32)
#define LL_ATON_NETWORK_OUT_1_SIZE_BYTES  (69632)
